...
// db.js builds the map; roomid.js decides which room is which. The import goes both
// ways because importing an area triggers identification, and identifying a room
// rewrites the map -- ES module function bindings hoist, so the cycle is fine.
import { dropContradictedAnchors, gaardianAreaIdFor, promoteAnchoredRooms,
         promoteGaardianRoom, reconnectDanglingExits } from './roomid.js';
 ...
 */
export function cleanExitAction(action){
